...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep punctuation with the sentence while accepting spaces and newlines
        # after it as sentence boundaries.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # A separator that does not occur cannot make a useful split; try the
        # next priority level rather than returning an oversized chunk.
        if len(pieces) == 1:
        ...
        current = ""
        for piece in pieces:
            part = piece if not current else separator + piece
